...
!(function (t, n) {
  ...
  Wn(
    ...
    Zn(Kn, {
      ...
      rgb: function () {
        ...
        return new _e(
          Ue(3.1338561 * (n = Ne * Ie(n)) - 1.6168667 * (t = 1 * Ie(t)) - 0.4906146 * (e = Ce * Ie(e))),
    ...
    function h(e) {
      ...
      function Y(t) {
        switch (t.keyCode) {
          ...
          case 18:
            m === To &&
              (x && ((l = h - C * x), (i = a + C * x)), w && ((d = p - P * w), (u = c + P * w)), (m = So), U());
            break;
          case 32:
            (m !== To && m !== So) ||
              (x < 0 ? (l = h - C) : x > 0 && (i = a - C),
  ...
  function os(t, n) {
    ...
    var e = Cc((n *= Sc)),
      ...
      o = Fc(n),
      a = Nc(
        Ic((a = Yf * o - Lf * i) * a + (a = Lf * r - Bf * o) * a + (a = Bf * i - Yf * r) * a),
        Bf * r + Yf * i + Lf * o
      );
  ...
  function Ev(t, n, e, r, i, o, a, u, c, f) {
    ...
    return (
      ...
      (s.nice = function (t) {
        var e = h();
        return (
          (t && "function" == typeof t.range) || (t = n(e[0], e[e.length - 1], null == t ? 10 : t)), t ? h(mp(e, t)) : s
        );
      }),
      (s.copy = function () {
  ...
  (ex.prototype = tx.prototype),
        ...
        if ((u || (u = c = fa()), l < s && ((f = l), (l = s), (s = f)), l > lb))
          if (p > pb - lb)
            ...
            if (T > lb) {
              var N = yb((T / s) * fb(A)),
                C = yb((T / l) * fb(A));
              (w -= 2 * N) > lb ? ((m += N *= g ? 1 : -1), (x -= N)) : ((w = 0), (m = x = (h + d) / 2)),
                (M -= 2 * C) > lb ? ((_ += C *= g ? 1 : -1), (b -= C)) : ((M = 0), (_ = b = (h + d) / 2));
            }
            var P = l * ab(_),
              z = l * fb(_),
              D = s * ab(x),
              ...
              ? k > lb
                ? ((y = Mb(I, U, P, z, l, k, g)),
                  ...
                  k < S
                    ...
                    : (u.arc(y.cx, y.cy, k, ob(y.y01, y.x01), ob(y.y11, y.x11), !g),
                      u.arc(0, 0, l, ob(y.cy + y.y11, y.cx + y.x11), ob(v.cy + v.y11, v.cx + v.x11), !g),
                      u.arc(v.cx, v.cy, k, ob(v.y11, v.x11), ob(v.y01, v.x01), !g)))
              ...
              s > lb && w > lb
                ? E > lb
                  ? ((y = Mb(D, q, F, O, s, -E, g)),
                    ...
                    E < S
                      ? u.arc(y.cx, y.cy, E, ob(y.y01, y.x01), ob(v.y01, v.x01), !g)
                      : (u.arc(y.cx, y.cy, E, ob(y.y01, y.x01), ob(y.y11, y.x11), !g),
                        u.arc(0, 0, s, ob(y.cy + y.y11, y.cx + y.x11), ob(v.cy + v.y11, v.cx + v.x11), g),
                        u.arc(v.cx, v.cy, E, ob(v.y11, v.x11), ob(v.y01, v.x01), !g)))
                  : u.arc(0, 0, s, x, m, g)
                : u.lineTo(D, q);
          }
        else u.moveTo(0, 0);
        ...
        (b.clipExtent = function (t) {
          return arguments.length
            ? ((v =
                null == t
                  ? ((d = e = r = i = null), fl)
                  : Us((d = +t[0][0]), (e = +t[0][1]), (r = +t[1][0]), (i = +t[1][1]))),
              _())
            : null == d
            ? null
            : [
    ...
    (t.scaleTime = function () {
      return rp.apply(
        Ev(Kg, Qg, xg, bg, og, eg, tg, Qp, Zp, t.timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
        arguments
      );
    }),
    (t.scaleUtc = function () {
      return rp.apply(
        Ev(Wg, Zg, Gg, Hg, Cg, Eg, Tg, Mg, Zp, t.utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]),
        arguments
      );
    }),
    (t.scan = function (t, n) {
